...
import { chartConfig, chartData, transactions } from '../bank/constants'
...
const Bank = () => {
  ...
  const transactionsGrouped = transactions && transactions.length > 0 ? groupTransaction(transactions) : null;
  
  return (
    <section className="p-6 w-full max-w-7xl mx-auto min-h-screen">
