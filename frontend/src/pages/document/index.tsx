...
export const Files = () => {
  ...
  const uploadMutation = useMutation({
    ...
    onSuccess: () => {
      // 1. Força a atualização da lista de documentos na tela
      queryClient.invalidateQueries({ queryKey: ["documents"] });
      // 2. Fecha o modal só agora que deu certo!
  ...
  return (
    <div className="p-6 w-full max-w-7xl mx-auto h-full">
      ...
      >
        <h1 className="heading-lg tracking-tight group-hover:text-gray-500 dark:group-hover:text-gray-300">
          Arquivos
        </h1>
